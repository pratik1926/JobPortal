...
//                 setIsVerified(false); // reset if email changes
//               }}
...
//                 className="w-full py-3 px-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500"
//               />
//               <button
//                 type="button"
...
//               required
//               onChange={(e) => setForm({ ...form, password: e.target.value })}
//               className="w-full pl-10 pr-10 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500"
//             />
//             <div
//               onClick={() => setShowPassword(!showPassword)}
