...
//   return (
//     <div className="p-4">
//       <h2 className="text-lg font-semibold mb-3">Bulk Job Upload</h2>

//       <input type="file" accept=".xlsx, .xls" onChange={handleFileUpload} />

//       <div className="mt-4">
//         <DataGrid dataSource={jobs} keyExpr="id" showBorders={true}>
...
//             dataField="skills"
//             caption="Skills"
//             calculateCellValue={(row) => row.skills.join(", ")}
//           />
