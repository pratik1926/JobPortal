...
namespace JobPortal.Application.Interfaces
{
    public interface IJobService
    {
        ...
        Task<Job> GetJobByIdAsync(int jobId, int? requesterSeekerId = null);

        Task<(List<JobDto> jobs, int total)> GetPagedJobsAsync(int page, int pageSize, int? seekerId = null);
